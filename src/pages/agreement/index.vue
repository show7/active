<template>
  <div class="agreement-box">
    ...
    <div>
      ...
      © 违反法律规定或违反本应用规则行为及本应用已对您采取的措施。 信息使用<br />
      ...
      (d)
      如您出现违反中国有关法律、法规或者本应用服务协议或相关规则的情况，需要向第三方披露；<br />
      (e)
      如您是适格的知识产权投诉人并已提起投诉，应被投诉人要求，向被投诉人披露，以便双方处理可能的权利纠纷；<br />
      (f)
      在本应用平台上创建的某一交易中，如交易任何一方履行或部分履行了交易义务并提出信息披露请求的，本应用有权决定向该用户提供其交易对方的联络方式等必要信息，以促成交易的完成或纠纷的解决。<br />
      ...
      (b)
      您有权选择接受或拒绝接受cookies。您可以通过修改浏览器设置的方式拒绝接受cookies。但如果您选择拒绝接受cookies，则您可能无法登录或使用依赖于cookies的本应用网络服务或功能。<br />
      © 通过本应用所设cookies所取得的有关信息，将适用本政策。 信息安全<br />
      (a)
      本应用帐号均有安全保护功能，请妥善保管您的用户名及密码信息。本应用将通过对用户密码进行加密等安全措施确保您的信息不丢失，不被滥用和变造。尽管有前述安全措施，但同时也请您注意在信息网络上不存在“完善的安全措施”。
      (b)
      在使用本应用网络服务进行网上交易时，您不可避免的要向交易对方或潜在的交易对<br />
      7.乙方对甲方授予使用的图片，不得再许可任何第三方对该图片的全部或局部进行再许可；不得向任何第三方对该图片的全部或局部进行买卖、转让、租借，不得将该图片的全部或局部或允许任何第三方将该图片的全部或局部作为任何一种服务标志或商标的全部或局部，不得在除本协议约定之外的任何网站或局域网或网络公告牌（BBS）上复制或展示该图片的全部或局部，不得将该图片的全部或局部放置在网上任何可供下载的位置或FTP格式下，不得将该图片的全部或局部用于诋毁或损害他人名誉、欺诈、侵犯、扭曲事实或其它一切非法用途。否则，由此造成的一切损失由乙方承担。若甲方因此受到第三方的索赔，则甲方有权向乙方追偿其所受到的所有损失和支出，包括但不限于律师费、诉讼费、赔偿金等。、未经甲方明确的事先书面许可，乙方不得将图片用于本协议未列出的用途。甲方保证图片内容的完整性。
      8.本隐私政策的更改<br />
      ...
      如您对本政策或其他相关事宜有疑问，请通过 http://www.dafengge.top/
      与我们联系。您也可将您的问题发送至1148153349@qq.com或寄到如下地址：
      地址：山东省济南市槐荫区张庄路132号华东汽配城D层2号（收） 邮编：250000
    </div>
  </div>
</template>
<script>
